...
protected $_bypass = TRUE;
    ...
    public function showService() {
    	...
    	if (isset($session->Service)) {$session->Service = null;}
    	if (isset($session->ServiceElement)) {$session->ServiceElement = null;}
    	if (isset($session->ServiceElementTemplate)) {$session->ServiceElementTemplate = null;}
