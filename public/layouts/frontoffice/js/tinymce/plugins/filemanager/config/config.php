...
require_once './../../../../../../../library/Portal/Preference/Preference.php';
//session_start();
$Opref = $_SESSION['Zend_Auth']['pref'];

// on cree un rep par organisation.
$structure = $_SERVER['DOCUMENT_ROOT'] .'files/upload/org/'.sha1($Opref->_org_name);

if (!mkdir($structure, 0777, true)) {
	error_log('Echec lors de la création du répertoires '.$_SERVER['DOCUMENT_ROOT'] .'files/upload/org/'.sha1($Opref->_org_name));
	//error_log('Organization : '.$Opref->_org_name);
}
...
$config = array(
	...
	*/
	...
	'upload_dir' => '/source/',*/
	'upload_dir' => '/files/upload/org/'.sha1($Opref->_org_name).'/',
	/*
	|--------------------------------------------------------------------------
	...
	'current_path' => '../source/',*/
	'current_path' => './../../../../../../files/upload/org/'.sha1($Opref->_org_name).'/',
	...
	|
	*/
	'thumbs_base_path' => './../../../../../../files/upload/thumbs/'.sha1($Opref->_org_name).'/',
